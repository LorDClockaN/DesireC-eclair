...
#define CFG_SET_OV_LSC_RAW_CAPTURE	32 /*vincent for LSC calibration*/
...
struct aec_statistic_cfg{
	uint16_t luma_target;
	uint16_t current_luma;
	uint32_t exp_index;
};
...
enum aec_metering_mode{
	CAMERA_METERING_AVERAGE,
	CAMERA_METERING_CENTERING,
	CAMERA_METERING_SPOT,
	CAMERA_METERING_ZONE1,
	CAMERA_METERING_ZONE2,
	CAMERA_METERING_ZONE3,
	CAMERA_METERING_ZONE4,
	CAMERA_METERING_ZONE5,
	CAMERA_METERING_ZONE6,
	CAMERA_METERING_ZONE7,
	CAMERA_METERING_ZONE8,
	CAMERA_METERING_ZONE9,
	CAMERA_METERING_ZONE10,
	CAMERA_METERING_ZONE11,
	CAMERA_METERING_ZONE12,
	CAMERA_METERING_ZONE13,
	CAMERA_METERING_ZONE14,
	CAMERA_METERING_ZONE15,
	CAMERA_METERING_ZONE16,
};
...
struct sensor_cfg_data {
	...
	union {
		...
		enum aec_metering_mode metering_value;
		struct coor_cfg coor_value;
		struct aec_statistic_cfg aec_stat_value;
		uint32_t exp_idx_value;
	} cfg;
};
