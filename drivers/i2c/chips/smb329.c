...
int set_charger_ctrl(u32 ctl)
{
	...
	case DISABLE:
		...
		pr_info("batt: Switch charger ON (SLOW): reg_05h=%x, reg_31h=%x\n", reg_05h, reg_31h);
		pr_info("batt: Switch charger ON (SLOW) DEBUG: reg_00h=%x, reg_01h=%x, reg_33h=%x\n", reg_00h, reg_01h, reg_33h);
		pr_info("batt: Switch charger ON (SLOW) DEBUG: reg_35h=%x, reg_36h=%x, reg_37h=%x\n", reg_35h, reg_36h, reg_37h);
	...
	case ENABLE_SLOW_CHG:
		...
		smb329_i2c_read_byte(&reg_37h, 0x37);
		pr_info("batt: Switch charger ON (SLOW): reg_05h=%x, reg_31h=%x\n", reg_05h, reg_31h);
		pr_info("batt: Switch charger ON (SLOW) DEBUG: reg_00h=%x, reg_01h=%x\n", reg_00h, reg_01h);
		pr_info("batt: Switch charger ON (SLOW) DEBUG: reg_35h=%x, reg_36h=%x, reg_37h=%x\n", reg_35h, reg_36h, reg_37h);
		break;
	case ENABLE_FAST_CHG:
		...
		smb329_i2c_read_byte(&reg_36h, 0x36);
		smb329_i2c_read_byte(&reg_37h, 0x37);
		pr_info("batt: Switch charger ON (FAST): reg_05h=%x, reg_31h=%x, version=%x\n", reg_05h, reg_31h, version);
		pr_info("batt: Switch charger ON (FAST) DEBUG: reg_00h=%x, reg_01h=%x\n", reg_00h, reg_01h);
		pr_info("batt: Switch charger ON (FAST) DEBUG: reg_35h=%x, reg_36h=%x, reg_37h=%x\n", reg_35h, reg_36h, reg_37h);
		break;
	case CHARGER_CHK:
