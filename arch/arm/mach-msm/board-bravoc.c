...
static int bravoc_phy_init_seq[] = { 0x0C, 0x31, 0x31, 0x32, 0x1D, 0x0D, 0x1D, 0x10, -1 };

static struct msm_hsusb_product bravoc_usb_products[] = {
	{
		.product_id	= 0x0ff9,
...
static void __init bravoc_init(void)
{
	...
	msm_hsusb_set_product(bravoc_usb_products,
		ARRAY_SIZE(bravoc_usb_products));
